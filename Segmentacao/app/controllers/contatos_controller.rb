class ContatosController < ApplicationController
  ...
  def listaAnd	
		@contatos = Contato.where("estado like 'sc' and idade > '30'")
  end
  
   def listaOr	
		@contatos = Contato.where("cargo like 'diretor de marketing' or estado like 'sp' ")
  end
  
  def index
	if params[:estado]
		@contatos = Contato.where("estado like '%#{params[:estado]}%' and idade = '#{params[:idade]}'")
	else
